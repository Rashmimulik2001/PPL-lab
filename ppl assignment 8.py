...
class Paint():
    def __init__(self, root):
        ...
        #for drawing with different color pain
        ...
        colors = ['#f00000','#ff4dd2','#ffff33','#000000','#0066ff','#660033','#4dff4d','#b300b3','#00ffff','#808080','#99ffcc','#336600','#ff9966','#ff99ff','#00cc99']
        i=j=0
        for color in colors:
        ...
        #creating scale for pen & eraser size
    ...
    def save_paint(self):
        try:
            ...
            messagebox.showinfo('paint says', 'imaged is saved as' +str(filename))
        except:
